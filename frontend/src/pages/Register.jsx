...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-indigo-600/10 rounded-full filter blur-[60px] pointer-events-none transform translate-z-0"></div>
      <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-rose-600/5 rounded-full filter blur-[60px] pointer-events-none transform translate-z-0"></div>
